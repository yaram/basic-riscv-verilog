...
run_command('ld.lld', '-T', os.path.join(source_directory, 'linker.ld'), '-o', os.path.join(build_directory, 'rom.bin'), '-e', 'entry', '-m', 'elf32lriscv', '--oformat', 'binary', os.path.join(build_directory, 'asm.o'), os.path.join(build_directory, 'main.o'))
